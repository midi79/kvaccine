...
<v-card style="width:300px; margin-left:5%;" outlined>
    ...
    <v-card-text style = "margin-left:-15px; margin-top:10px;">
          ...
          <div class="grey--text ml-4" v-if="editMode" style = "margin-top:-20px;">
            <v-text-field label="HospitalName" v-model="value.hospitalName"/>
          </div>
          ...
          <div class="grey--text ml-4" v-if="editMode" style = "margin-top:-20px;">
            <v-text-field type="number" label="UesrId" v-model="value.uesrId"/>
          </div>
          <div class="grey--text ml-4" v-else>
            UesrId :  {{value.uesrId }}
          </div>
          ...
          <div class="grey--text ml-4" v-if="editMode" style = "margin-top:-20px;">
            <v-text-field label="UserRegNumber" v-model="value.userRegNumber"/>
          </div>
          <div class="grey--text ml-4" v-else>
            UserRegNumber :  {{value.userRegNumber }}
          </div>
          ...
          <div class="grey--text ml-4" v-if="editMode" style = "margin-top:-20px;">
            <v-text-field label="InjectDate" v-model="value.injectDate"/>
          </div>
          <div class="grey--text ml-4" v-else>
            InjectDate :  {{value.injectDate }}
          </div>

          <div class="grey--text ml-4" v-if="editMode" style = "margin-top:-20px;">
            <v-text-field label="InjectType" v-model="value.injectType"/>
          </div>
          <div class="grey--text ml-4" v-else>
            InjectType :  {{value.injectType }}
          </div>
